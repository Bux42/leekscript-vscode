// imported from leek-wars-generator version 1.10.0
...
public class FightFunctions {
    ...
    static {
        ...
        method("getEffects", "Entity", 25, true, new CallableVersion[] {
                new CallableVersion(Type.compound(Type.array(Type.array(Type.INT_OR_BOOL)), Type.NULL),
                        new Type[] { Type.INT_OR_NULL }),
        ...
        method("getItemUses", "Entity", 15, true, Type.INT, new Type[] { Type.INT });
        ...
        method("getWeaponEffectiveArea", "Weapon", 78, true, new CallableVersion[] {
                new CallableVersion(Type.ARRAY_INT_OR_NULL,
                        new Type[] { Type.INT, Type.INT_OR_NULL, Type.INT_OR_NULL }),
                new CallableVersion(Type.ARRAY_INT_OR_NULL, new Type[] { Type.INT, Type.INT_OR_NULL }),
                new CallableVersion(Type.ARRAY_INT_OR_NULL, new Type[] { Type.INT }),
        });
        method("getAllWeapons", "Weapon", 200, true, Type.ARRAY_INT, new Type[0]);
        method("getWeaponMaxUses", "Weapon", 15, true, new CallableVersion[] {
                new CallableVersion(Type.INT, new Type[] { Type.INT }),
                new CallableVersion(Type.INT),
        });
        ...
        method("getChipEffects", "Chip", 125, true, Type.compound(Type.array(Type.array(Type.INT_OR_REAL)), Type.NULL),
                new Type[] { Type.INT });
        ...
        method("lineOfSight", "Field", 31, true, new CallableVersion[] {
                new CallableVersion(Type.BOOL_OR_NULL,
                        new Type[] { Type.INT, Type.INT, Type.compound(Type.ARRAY_INT, Type.INT, Type.NULL) }),
        ...
        method("getCellsToUseWeapon", "Fight", 25834, true, new CallableVersion[] {
                new CallableVersion(Type.ARRAY_INT_OR_NULL,
                        new Type[] { Type.INT, Type.INT_OR_NULL, Type.ARRAY_INT_OR_NULL }),
                new CallableVersion(Type.ARRAY_INT_OR_NULL, new Type[] { Type.INT, Type.INT_OR_NULL }),
                new CallableVersion(Type.ARRAY_INT_OR_NULL, new Type[] { Type.INT }),
        });
        ...
        method("mark", "Util", 164, true, new CallableVersion[] {
                new CallableVersion(Type.BOOL,
                        new Type[] { Type.compound(Type.ARRAY_INT, Type.INT), Type.INT, Type.INT }),
        ...
        method("markText", "Util", 164, true, new CallableVersion[] {
                new CallableVersion(Type.BOOL,
                        new Type[] { Type.compound(Type.ARRAY_INT, Type.INT), Type.ANY, Type.INT, Type.INT }),
                new CallableVersion(Type.BOOL,
                        new Type[] { Type.compound(Type.ARRAY_INT, Type.INT), Type.ANY, Type.INT }),
    ...
    private static LeekFunctions method(String name, String clazz, int operations, boolean isStatic, Type return_type,
            Type[] arguments) {
        return method(name, clazz, operations, isStatic,
                new CallableVersion[] { new CallableVersion(return_type, arguments) });
    }
    ...
    private static LeekFunctions method(String name, String clazz, int operations, boolean isStatic,
            CallableVersion[] versions) {
